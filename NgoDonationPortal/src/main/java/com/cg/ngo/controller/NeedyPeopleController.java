...
public class NeedyPeopleController {
	...
	public NeedyPeople validateNeedyPeople(@PathVariable("userName") String userName, @PathVariable("password") String password) 
	{
		NeedyPeople needyPeople = needyPeopleServiceImpl.login(userName, password);
		return needyPeople;
	}
